...
const SearchResultComponent: FC<SearchResultProps> = ({
  ...
  const [movieDetails, setMovieDetails] =
    useState<MovieResult | undefined>(undefined);
  ...
  return (
    <div className="container mt-20">
      ...
      <div className="movie-results">
        {searchResult?.Response.toLowerCase() === 'true' &&
          searchResult.Search.map((searchItem, index) => (
            <div
            ...
            >
              ...
              <img
                ...
                src={
                  searchItem.Poster.startsWith('http')
                    ? searchItem.Poster
                    : NO_IMG
                }
      ...
      {searchResult && searchResult?.Response.toLowerCase() !== 'true' && (
        <ErrorComponent errorMessage={searchResult?.Error} />
      )}
      {totalPages > 1 && (
